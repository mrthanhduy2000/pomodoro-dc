# CHANGELOG archive — entries up to 2026-08 (frozen 2026-09-06, ADR-075)

> 135 dated entries moved verbatim out of the active `CHANGELOG.md`. **Nothing was deleted or
> rewritten.** The active file was 266,956 chars ≈ 155k tokens = 78% of a 200k context window and the
> largest file in the repository, while 80% of its bulk was a single past month. A changelog is read
> for *recent* milestones; older months belong in an archive opened deliberately.
>
> Index without reading the file: `node scripts/doc-budget.mjs --map docs/archive/CHANGELOG_upto_2026-08.md`
