...
import { SIDES_HANDMADE, countSpecTriangles, gable, prism, specHeight } from './parts';
...
const INFRA_BUILDERS = {
  ...
  granary: (seed) => [
    prism({ y: 0, w: 0.34, h: 0.36 + unit(`${seed}|h`) * 0.12, sides: SIDES_HANDMADE, wobble: HANDMADE_WOBBLE, taper: 0.9, role: 'wall' }),
    prism({ y: 0.40, w: 0.36, h: 0.18, sides: SIDES_HANDMADE, wobble: HANDMADE_WOBBLE, taper: 0.1, role: 'roof' }),
  ],
  ...
  windmill: (seed, _style, detail) => {
    ...
    const parts = [
      prism({ y: 0, w: 0.32, h: cao, sides: SIDES_HANDMADE, wobble: HANDMADE_WOBBLE, taper: 0.66, role: 'wall' }),
      prism({ y: cao, w: 0.26, h: 0.12, sides: SIDES_HANDMADE, wobble: HANDMADE_WOBBLE, taper: 0.35, role: 'roof' }),
    ];
  ...
  chimney: (seed) => [
    ...
    prism({ y: 0.12, w: 0.17, h: 0.98 + unit(`${seed}|h`) * 0.34, sides: SIDES_HANDMADE, wobble: HANDMADE_WOBBLE, taper: 0.62, role: 'wall' }),
  ],
  ...
  kiln: (seed) => [
    prism({ y: 0, w: 0.40, h: 0.42 + unit(`${seed}|h`) * 0.12, sides: SIDES_HANDMADE, wobble: HANDMADE_WOBBLE, taper: 0.52, role: 'wall' }),
    prism({ y: 0.40, w: 0.13, h: 0.10, sides: SIDES_HANDMADE, wobble: HANDMADE_WOBBLE, role: 'dark' }),
  ],
