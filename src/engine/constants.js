...
export const ACHIEVEMENTS = [
  ...
  // ══ CHUỖI LIÊN TIẾP (25) ═════════════════════════════════════════════════
  { id:'streak_2',   category:'streak', tier:'bronze',   icon:'🌱', label:'Bắt Đầu',                description:'Chuỗi 2 ngày liên tiếp',   dem:'longestStreak', moc:2 },
  { id:'streak_3',   category:'streak', tier:'bronze',   icon:'🌿', label:'Mầm Thói Quen',           description:'Chuỗi 3 ngày liên tiếp',   dem:'longestStreak', moc:3 },
  { id:'streak_5',   category:'streak', tier:'bronze',   icon:'🌊', label:'Sóng Nhỏ',                description:'Chuỗi 5 ngày liên tiếp',   dem:'longestStreak', moc:5 },
  { id:'streak_7',   category:'streak', tier:'silver',   icon:'📅', label:'Sóng Tuần',               description:'Chuỗi 7 ngày liên tiếp',   dem:'longestStreak', moc:7 },
  { id:'streak_10',  category:'streak', tier:'silver',   icon:'🔗', label:'Xích Không Đứt',          description:'Chuỗi 10 ngày liên tiếp',  dem:'longestStreak', moc:10 },
  { id:'streak_14',  category:'streak', tier:'silver',   icon:'🌿', label:'Hai Tuần Vững Chắc',      description:'Chuỗi 14 ngày liên tiếp',  dem:'longestStreak', moc:14 },
  { id:'streak_21',  category:'streak', tier:'silver',   icon:'🎯', label:'Ba Tuần Thần Thánh',      description:'Chuỗi 21 ngày — khoa học: thói quen hình thành', dem:'longestStreak', moc:21 },
  { id:'streak_30',  category:'streak', tier:'gold',     icon:'🌳', label:'Cây Trưởng Thành',        description:'Chuỗi 30 ngày liên tiếp',  dem:'longestStreak', moc:30 },
  { id:'streak_40',  category:'streak', tier:'gold',     icon:'🦋', label:'Biến Đổi Hoàn Toàn',      description:'Chuỗi 40 ngày liên tiếp',  dem:'longestStreak', moc:40 },
  { id:'streak_50',  category:'streak', tier:'gold',     icon:'🔥', label:'Lửa Không Tắt',           description:'Chuỗi 50 ngày liên tiếp',  dem:'longestStreak', moc:50 },
  { id:'streak_60',  category:'streak', tier:'gold',     icon:'🏔️', label:'Núi Kiên Vững',           description:'Chuỗi 60 ngày liên tiếp',  dem:'longestStreak', moc:60 },
  { id:'streak_75',  category:'streak', tier:'gold',     icon:'⚡', label:'Bảy Mươi Lăm Ngày',       description:'Chuỗi 75 ngày liên tiếp',  dem:'longestStreak', moc:75 },
  { id:'streak_90',  category:'streak', tier:'platinum', icon:'🌙', label:'Ba Tháng Bất Khuất',      description:'Chuỗi 90 ngày liên tiếp',  dem:'longestStreak', moc:90 },
  { id:'streak_100', category:'streak', tier:'platinum', icon:'👁️', label:'Bất Diệt',               description:'Chuỗi 100 ngày liên tiếp', dem:'longestStreak', moc:100 },
  { id:'streak_120', category:'streak', tier:'platinum', icon:'🌊', label:'Bốn Tháng Đại Dương',     description:'Chuỗi 120 ngày liên tiếp', dem:'longestStreak', moc:120 },
  { id:'streak_150', category:'streak', tier:'platinum', icon:'🦅', label:'Đại Bàng Bay Cao',        description:'Chuỗi 150 ngày liên tiếp', dem:'longestStreak', moc:150 },
  { id:'streak_180', category:'streak', tier:'platinum', icon:'🌟', label:'Nửa Năm Hào Quang',       description:'Chuỗi 180 ngày liên tiếp', dem:'longestStreak', moc:180 },
  { id:'streak_200', category:'streak', tier:'diamond',  icon:'💎', label:'Hai Trăm Ngày Kim Cương', description:'Chuỗi 200 ngày liên tiếp', dem:'longestStreak', moc:200 },
  { id:'streak_250', category:'streak', tier:'diamond',  icon:'🌌', label:'Dải Ngân Hà Thói Quen',   description:'Chuỗi 250 ngày liên tiếp', dem:'longestStreak', moc:250 },
  { id:'streak_300', category:'streak', tier:'diamond',  icon:'🔱', label:'Ba Trăm Ngày Thần Thánh', description:'Chuỗi 300 ngày liên tiếp', dem:'longestStreak', moc:300 },
  { id:'streak_365', category:'streak', tier:'diamond',  icon:'☀️', label:'Mặt Trời Không Tắt',     description:'Chuỗi 365 ngày — một năm không bỏ cuộc', dem:'longestStreak', moc:365 },
  { id:'streak_400', category:'streak', tier:'diamond',  icon:'🌠', label:'Bốn Trăm Ngày',           description:'Chuỗi 400 ngày liên tiếp', dem:'longestStreak', moc:400 },
  { id:'streak_450', category:'streak', tier:'diamond',  icon:'🚀', label:'Vượt Ranh Giới',          description:'Chuỗi 450 ngày liên tiếp', dem:'longestStreak', moc:450 },
  { id:'streak_500', category:'streak', tier:'diamond',  icon:'👑', label:'Vua Chuỗi',               description:'Chuỗi 500 ngày liên tiếp', dem:'longestStreak', moc:500 },
  { id:'streak_730', category:'streak', tier:'diamond',  icon:'∞',  label:'Hai Năm Không Ngơi',      description:'Chuỗi 730 ngày — hai năm liên tiếp', dem:'longestStreak', moc:730 },
  ...
  { id:'first_relic',     category:'collection', tier:'bronze',   icon:'🌟', label:'Người Sưu Tập Huyền Thoại', description:'Chinh phục Khủng Hoảng Kỷ Nguyên, nhận Di Vật đầu tiên', dem:'relicsCount', moc:1 },
  ...
  { id:'jackpot_100',     category:'collection', tier:'diamond',  icon:'💸', label:'Vua Đại Trúng Thưởng',              description:'100 lần Đại Trúng Thưởng',               dem:'totalJackpots', moc:100 },
  ...
  // Chuỗi thêm
  { id:'streak_15',      category:'streak',    tier:'silver',   icon:'🔗', label:'Mười Lăm Ngày',            description:'Chuỗi 15 ngày liên tiếp',               dem:'longestStreak', moc:15 },
  { id:'streak_45',      category:'streak',    tier:'gold',     icon:'🌟', label:'Bốn Mươi Lăm Ngày',        description:'Chuỗi 45 ngày liên tiếp',               dem:'longestStreak', moc:45 },
  // Time of day thêm
