# BAN_GIAO archive — journal entries and phase logs before 2026-09-06 (frozen 2026-09-06, ADR-075)

> Moved verbatim out of the active `BAN_GIAO.md`. **Nothing was deleted or rewritten.**
> `PHASE_RULES.md` §5 already required this ("past ~500 lines, move the old part to `docs/archive/`");
> the file had reached 3,109 lines / 240,561 chars ≈ 70% of a 200k context window without it ever
> being enforced. The active file keeps the newest entries and the live state sections.
>
> Index without reading: `node scripts/doc-budget.mjs --map docs/archive/BAN_GIAO_2026-09.md`
