...
const RICH = [
  ...
  'Loại việc: Viết lách 11.5h, 14 phiên, đạt mục tiêu 64% (trên 14 phiên) | Đọc tài liệu 6.2h, 8 phiên.',
  'Hay bỏ giữa chừng vào buổi tối: 41% (trên 12 lần bắt đầu).',
  'Phiên sau 22h: tỉ lệ đạt 30% so với ban ngày 70% (khuya trên 6 phiên có mục tiêu). Đây là tương quan, không phải kết luận.',
