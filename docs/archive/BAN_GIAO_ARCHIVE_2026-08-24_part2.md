# BÀN GIAO ARCHIVE — part 2 (entries dated 2026-08-18 and earlier)

> Second half of [`BAN_GIAO_ARCHIVE_2026-08-24.md`](BAN_GIAO_ARCHIVE_2026-08-24.md), split on
> 2026-09-06 (ADR-075): the original was 141% of a 200k context window, i.e. unreadable in one
> session by construction. **Nothing was deleted or rewritten.**
> Index without reading: `node scripts/doc-budget.mjs --map docs/archive/BAN_GIAO_ARCHIVE_2026-08-24_part2.md`
