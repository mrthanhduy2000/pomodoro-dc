...
export function createCityScene({
  ...
  // ⚠️ ĐÃ ĐO, ĐỪNG SIẾT THÊM: khối đổ bóng xa tâm nhất trong cả 15 kỷ nằm ở bán kính 9,2275 còn
  // `reach` là 9,60 (xem `SHADOW_MAP_DESKTOP`). Chỗ dư 4% ấy là toàn bộ biên an toàn.
