import { checkTuNguong } from './achievementProgress.js';
/**
 * constants.js
 * ─────────────────────────────────────────────────────────────────────────────
...
export const ACHIEVEMENTS = [
  ...
  // ══ PHIÊN HỌC (28) ═══════════════════════════════════════════════════════
  { id:'first_session',  category:'sessions', tier:'bronze',   icon:'🔥', label:'Khởi Đầu Bùng Cháy',      description:'Hoàn thành phiên tập trung đầu tiên',     dem:'sessionsCompleted', moc:1 },
  { id:'sessions_5',     category:'sessions', tier:'bronze',   icon:'💧', label:'Chớm Hình Thành',           description:'5 phiên tập trung',                       dem:'sessionsCompleted', moc:5 },
  { id:'sessions_10',    category:'sessions', tier:'bronze',   icon:'💪', label:'Kiên Trì',                  description:'10 phiên tập trung',                      dem:'sessionsCompleted', moc:10 },
  { id:'sessions_25',    category:'sessions', tier:'bronze',   icon:'🛡️',label:'Không Bỏ Cuộc',            description:'25 phiên tập trung',                      dem:'sessionsCompleted', moc:25 },
  { id:'sessions_50',    category:'sessions', tier:'silver',   icon:'⚔️', label:'Chiến Binh',               description:'50 phiên tập trung',                      dem:'sessionsCompleted', moc:50 },
  { id:'sessions_75',    category:'sessions', tier:'silver',   icon:'🌿', label:'Vững Chắc',                 description:'75 phiên tập trung',                      dem:'sessionsCompleted', moc:75 },
  { id:'sessions_100',   category:'sessions', tier:'gold',     icon:'🏆', label:'Huyền Thoại Tập Trung',     description:'100 phiên tập trung',                     dem:'sessionsCompleted', moc:100 },
  { id:'sessions_150',   category:'sessions', tier:'gold',     icon:'🌊', label:'Sóng Không Ngừng',          description:'150 phiên tập trung',                     dem:'sessionsCompleted', moc:150 },
  { id:'sessions_200',   category:'sessions', tier:'gold',     icon:'🔱', label:'Bất Khả Chiến Bại',         description:'200 phiên tập trung',                     dem:'sessionsCompleted', moc:200 },
  { id:'sessions_250',   category:'sessions', tier:'gold',     icon:'🗡️', label:'Kẻ Săn Tri Thức',          description:'250 phiên tập trung',                     dem:'sessionsCompleted', moc:250 },
  { id:'sessions_300',   category:'sessions', tier:'platinum', icon:'🌋', label:'Ngọn Lửa Không Tắt',        description:'300 phiên tập trung',                     dem:'sessionsCompleted', moc:300 },
  { id:'sessions_365',   category:'sessions', tier:'platinum', icon:'🌏', label:'Nhà Sư Học',                description:'365 phiên — trung bình 1 phiên mỗi ngày', dem:'sessionsCompleted', moc:365 },
  { id:'sessions_500',   category:'sessions', tier:'platinum', icon:'🚀', label:'Siêu Nhân Tập Trung',       description:'500 phiên tập trung',                     dem:'sessionsCompleted', moc:500 },
  { id:'sessions_600',   category:'sessions', tier:'platinum', icon:'🌙', label:'Dũng Sĩ Bóng Đêm',         description:'600 phiên tập trung',                     dem:'sessionsCompleted', moc:600 },
  { id:'sessions_700',   category:'sessions', tier:'platinum', icon:'🦅', label:'Đại Bàng Tập Trung',        description:'700 phiên tập trung',                     dem:'sessionsCompleted', moc:700 },
  { id:'sessions_777',   category:'sessions', tier:'platinum', icon:'🍀', label:'Con Số May Mắn',             description:'777 phiên — số may mắn huyền thoại',      dem:'sessionsCompleted', moc:777 },
  { id:'sessions_888',   category:'sessions', tier:'platinum', icon:'🌟', label:'Tám Tám Tám Phiên',         description:'888 phiên — bộ số cát tường',             dem:'sessionsCompleted', moc:888 },
  { id:'sessions_1000',  category:'sessions', tier:'diamond',  icon:'🌌', label:'Đại Đạo Chí Giản',          description:'1000 phiên tập trung',                    dem:'sessionsCompleted', moc:1000 },
  { id:'sessions_1200',  category:'sessions', tier:'diamond',  icon:'💫', label:'Không Gian Và Thời Gian',   description:'1200 phiên tập trung',                    dem:'sessionsCompleted', moc:1200 },
  { id:'sessions_1500',  category:'sessions', tier:'diamond',  icon:'🌟', label:'Thiên Tài Trường Tồn',      description:'1500 phiên tập trung',                    dem:'sessionsCompleted', moc:1500 },
  { id:'sessions_2000',  category:'sessions', tier:'diamond',  icon:'☀️', label:'Ánh Dương Vĩnh Cửu',       description:'2000 phiên tập trung',                    dem:'sessionsCompleted', moc:2000 },
  { id:'sessions_2500',  category:'sessions', tier:'diamond',  icon:'🏔️', label:'Đỉnh Núi Cao Nhất',        description:'2500 phiên tập trung',                    dem:'sessionsCompleted', moc:2500 },
  { id:'sessions_3000',  category:'sessions', tier:'diamond',  icon:'🔱', label:'Thần Tập Trung',            description:'3000 phiên tập trung',                    dem:'sessionsCompleted', moc:3000 },
  { id:'sessions_4000',  category:'sessions', tier:'diamond',  icon:'🌀', label:'Xoáy Vũ Trụ',              description:'4000 phiên tập trung',                    dem:'sessionsCompleted', moc:4000 },
  { id:'sessions_5000',  category:'sessions', tier:'diamond',  icon:'👁️', label:'Mắt Toàn Tri',             description:'5000 phiên tập trung',                    dem:'sessionsCompleted', moc:5000 },
  { id:'sessions_7500',  category:'sessions', tier:'diamond',  icon:'∞',  label:'Vô Cực Tập Trung',         description:'7500 phiên tập trung',                    dem:'sessionsCompleted', moc:7500 },
  { id:'sessions_10000', category:'sessions', tier:'diamond',  icon:'🌠', label:'Mười Nghìn Phiên',          description:'10000 phiên tập trung',                   dem:'sessionsCompleted', moc:10000 },
  { id:'sessions_999',   category:'sessions', tier:'platinum', icon:'🎯', label:'Chín Chín Chín',            description:'999 phiên — gần đến nghìn',               dem:'sessionsCompleted', moc:999 },

  // ══ TÍCH LŨY THỜI GIAN (25) ══════════════════════════════════════════════
  { id:'hours_1',    category:'time', tier:'bronze',   icon:'⏰', label:'Giờ Vàng Đầu Tiên',   description:'1 giờ tập trung tích lũy',    dem:'totalFocusMinutes', moc:60 },
  { id:'hours_5',    category:'time', tier:'bronze',   icon:'⌛', label:'Năm Giờ Kiên Định',    description:'5 giờ tập trung tích lũy',    dem:'totalFocusMinutes', moc:300 },
  { id:'hours_10',   category:'time', tier:'bronze',   icon:'📚', label:'Thập Giờ Vàng',        description:'10 giờ tập trung tích lũy',   dem:'totalFocusMinutes', moc:600 },
  { id:'hours_25',   category:'time', tier:'silver',   icon:'📖', label:'Phần Tư Trăm Giờ',     description:'25 giờ tập trung tích lũy',   dem:'totalFocusMinutes', moc:1500 },
  { id:'hours_50',   category:'time', tier:'silver',   icon:'🕰️', label:'Bậc Thầy Thời Gian',  description:'50 giờ tập trung tích lũy',   dem:'totalFocusMinutes', moc:3000 },
  { id:'hours_75',   category:'time', tier:'silver',   icon:'⏳', label:'Bảy Mươi Lăm Giờ',    description:'75 giờ tập trung tích lũy',   dem:'totalFocusMinutes', moc:4500 },
  { id:'hours_100',  category:'time', tier:'gold',     icon:'🔮', label:'Trăm Giờ Hào Quang',   description:'100 giờ tập trung tích lũy',  dem:'totalFocusMinutes', moc:6000 },
  { id:'hours_150',  category:'time', tier:'gold',     icon:'🌙', label:'Đêm Học Vô Tận',       description:'150 giờ tập trung tích lũy',  dem:'totalFocusMinutes', moc:9000 },
  { id:'hours_200',  category:'time', tier:'gold',     icon:'🌊', label:'Biển Kiến Thức',        description:'200 giờ tập trung tích lũy',  dem:'totalFocusMinutes', moc:12000 },
  { id:'hours_250',  category:'time', tier:'gold',     icon:'🦁', label:'Sư Tử Học Thuật',       description:'250 giờ tập trung tích lũy',  dem:'totalFocusMinutes', moc:15000 },
  { id:'hours_300',  category:'time', tier:'platinum', icon:'🌌', label:'Ba Trăm Giờ Vũ Trụ',   description:'300 giờ tập trung tích lũy',  dem:'totalFocusMinutes', moc:18000 },
  { id:'hours_365',  category:'time', tier:'platinum', icon:'📅', label:'Một Năm Tập Trung',     description:'365 giờ — trung bình 1 giờ/ngày', dem:'totalFocusMinutes', moc:21900 },
  { id:'hours_400',  category:'time', tier:'platinum', icon:'⚡', label:'Bốn Trăm Giờ',          description:'400 giờ tập trung tích lũy',  dem:'totalFocusMinutes', moc:24000 },
  { id:'hours_500',  category:'time', tier:'platinum', icon:'🌋', label:'Ngọn Lửa Năm Trăm Giờ',description:'500 giờ tập trung tích lũy',  dem:'totalFocusMinutes', moc:30000 },
  { id:'hours_600',  category:'time', tier:'platinum', icon:'🔱', label:'Lục Trăm Giờ',          description:'600 giờ tập trung tích lũy',  dem:'totalFocusMinutes', moc:36000 },
  { id:'hours_700',  category:'time', tier:'platinum', icon:'🌟', label:'Thất Trăm Sao',         description:'700 giờ tập trung tích lũy',  dem:'totalFocusMinutes', moc:42000 },
  { id:'hours_800',  category:'time', tier:'diamond',  icon:'💎', label:'Tám Trăm Giờ Kim Cương',description:'800 giờ tập trung tích lũy',  dem:'totalFocusMinutes', moc:48000 },
  { id:'hours_1000', category:'time', tier:'diamond',  icon:'✨', label:'Thiên Tài Vĩnh Cửu',    description:'1000 giờ tập trung tích lũy', dem:'totalFocusMinutes', moc:60000 },
  { id:'hours_1200', category:'time', tier:'diamond',  icon:'🌠', label:'Ngàn Hai Trăm Giờ',     description:'1200 giờ tập trung tích lũy', dem:'totalFocusMinutes', moc:72000 },
  { id:'hours_1500', category:'time', tier:'diamond',  icon:'🔥', label:'Ngọn Lửa Bất Diệt',     description:'1500 giờ tập trung tích lũy', dem:'totalFocusMinutes', moc:90000 },
  { id:'hours_2000', category:'time', tier:'diamond',  icon:'👑', label:'Vua Thời Gian',          description:'2000 giờ tập trung tích lũy', dem:'totalFocusMinutes', moc:120000 },
  { id:'hours_2500', category:'time', tier:'diamond',  icon:'🌌', label:'Dải Ngân Hà',            description:'2500 giờ tập trung tích lũy', dem:'totalFocusMinutes', moc:150000 },
  { id:'hours_3000', category:'time', tier:'diamond',  icon:'∞',  label:'Vô Hạn Thời Gian',      description:'3000 giờ tập trung tích lũy', dem:'totalFocusMinutes', moc:180000 },
  { id:'hours_42',   category:'time', tier:'silver',   icon:'🌐', label:'Câu Trả Lời Vũ Trụ',    description:'42 giờ — con số câu trả lời cho mọi thứ', dem:'totalFocusMinutes', moc:2520 },
  { id:'hours_888',  category:'time', tier:'gold',     icon:'🍀', label:'Tám Tám Tám Giờ',        description:'888 giờ — bộ số cát tường',  dem:'totalFocusMinutes', moc:53280 },

  // ══ CHUỖI LIÊN TIẾP (25) ═════════════════════════════════════════════════
  { id:'streak_2',   category:'streak', tier:'bronze',   icon:'🌱', label:'Bắt Đầu',                description:'Streak 2 ngày liên tiếp',   dem:'longestStreak', moc:2 },
  { id:'streak_3',   category:'streak', tier:'bronze',   icon:'🌿', label:'Mầm Thói Quen',           description:'Streak 3 ngày liên tiếp',   dem:'longestStreak', moc:3 },
  { id:'streak_5',   category:'streak', tier:'bronze',   icon:'🌊', label:'Sóng Nhỏ',                description:'Streak 5 ngày liên tiếp',   dem:'longestStreak', moc:5 },
  { id:'streak_7',   category:'streak', tier:'silver',   icon:'📅', label:'Sóng Tuần',               description:'Streak 7 ngày liên tiếp',   dem:'longestStreak', moc:7 },
  { id:'streak_10',  category:'streak', tier:'silver',   icon:'🔗', label:'Xích Không Đứt',          description:'Streak 10 ngày liên tiếp',  dem:'longestStreak', moc:10 },
  { id:'streak_14',  category:'streak', tier:'silver',   icon:'🌿', label:'Hai Tuần Vững Chắc',      description:'Streak 14 ngày liên tiếp',  dem:'longestStreak', moc:14 },
  { id:'streak_21',  category:'streak', tier:'silver',   icon:'🎯', label:'Ba Tuần Thần Thánh',      description:'Streak 21 ngày — khoa học: thói quen hình thành', dem:'longestStreak', moc:21 },
  { id:'streak_30',  category:'streak', tier:'gold',     icon:'🌳', label:'Cây Trưởng Thành',        description:'Streak 30 ngày liên tiếp',  dem:'longestStreak', moc:30 },
  { id:'streak_40',  category:'streak', tier:'gold',     icon:'🦋', label:'Biến Đổi Hoàn Toàn',      description:'Streak 40 ngày liên tiếp',  dem:'longestStreak', moc:40 },
  { id:'streak_50',  category:'streak', tier:'gold',     icon:'🔥', label:'Lửa Không Tắt',           description:'Streak 50 ngày liên tiếp',  dem:'longestStreak', moc:50 },
  { id:'streak_60',  category:'streak', tier:'gold',     icon:'🏔️', label:'Núi Kiên Vững',           description:'Streak 60 ngày liên tiếp',  dem:'longestStreak', moc:60 },
  { id:'streak_75',  category:'streak', tier:'gold',     icon:'⚡', label:'Bảy Mươi Lăm Ngày',       description:'Streak 75 ngày liên tiếp',  dem:'longestStreak', moc:75 },
  { id:'streak_90',  category:'streak', tier:'platinum', icon:'🌙', label:'Ba Tháng Bất Khuất',      description:'Streak 90 ngày liên tiếp',  dem:'longestStreak', moc:90 },
  { id:'streak_100', category:'streak', tier:'platinum', icon:'👁️', label:'Bất Diệt',               description:'Streak 100 ngày liên tiếp', dem:'longestStreak', moc:100 },
  { id:'streak_120', category:'streak', tier:'platinum', icon:'🌊', label:'Bốn Tháng Đại Dương',     description:'Streak 120 ngày liên tiếp', dem:'longestStreak', moc:120 },
  { id:'streak_150', category:'streak', tier:'platinum', icon:'🦅', label:'Đại Bàng Bay Cao',        description:'Streak 150 ngày liên tiếp', dem:'longestStreak', moc:150 },
  { id:'streak_180', category:'streak', tier:'platinum', icon:'🌟', label:'Nửa Năm Hào Quang',       description:'Streak 180 ngày liên tiếp', dem:'longestStreak', moc:180 },
  { id:'streak_200', category:'streak', tier:'diamond',  icon:'💎', label:'Hai Trăm Ngày Kim Cương', description:'Streak 200 ngày liên tiếp', dem:'longestStreak', moc:200 },
  { id:'streak_250', category:'streak', tier:'diamond',  icon:'🌌', label:'Dải Ngân Hà Thói Quen',   description:'Streak 250 ngày liên tiếp', dem:'longestStreak', moc:250 },
  { id:'streak_300', category:'streak', tier:'diamond',  icon:'🔱', label:'Ba Trăm Ngày Thần Thánh', description:'Streak 300 ngày liên tiếp', dem:'longestStreak', moc:300 },
  { id:'streak_365', category:'streak', tier:'diamond',  icon:'☀️', label:'Mặt Trời Không Tắt',     description:'Streak 365 ngày — một năm không bỏ cuộc', dem:'longestStreak', moc:365 },
  { id:'streak_400', category:'streak', tier:'diamond',  icon:'🌠', label:'Bốn Trăm Ngày',           description:'Streak 400 ngày liên tiếp', dem:'longestStreak', moc:400 },
  { id:'streak_450', category:'streak', tier:'diamond',  icon:'🚀', label:'Vượt Ranh Giới',          description:'Streak 450 ngày liên tiếp', dem:'longestStreak', moc:450 },
  { id:'streak_500', category:'streak', tier:'diamond',  icon:'👑', label:'Vua Streak',               description:'Streak 500 ngày liên tiếp', dem:'longestStreak', moc:500 },
  { id:'streak_730', category:'streak', tier:'diamond',  icon:'∞',  label:'Hai Năm Không Ngơi',      description:'Streak 730 ngày — hai năm liên tiếp', dem:'longestStreak', moc:730 },

  // ══ THỜI ĐIỂM ĐẶC BIỆT (31) ══════════════════════════════════════════════
  { id:'early_bird_1',   category:'timeofday', tier:'bronze',   icon:'🌅', label:'Chim Sớm',              description:'1 phiên hoàn thành trước 7:00 sáng',   dem:'earlyBirdCount', moc:1 },
  { id:'early_bird_5',   category:'timeofday', tier:'bronze',   icon:'🌄', label:'Thói Quen Sáng Sớm',    description:'5 phiên hoàn thành trước 7:00 sáng',   dem:'earlyBirdCount', moc:5 },
  { id:'early_bird_10',  category:'timeofday', tier:'silver',   icon:'🌞', label:'Buổi Sáng Là Của Tao',  description:'10 phiên hoàn thành trước 7:00 sáng',  dem:'earlyBirdCount', moc:10 },
  { id:'early_bird_25',  category:'timeofday', tier:'silver',   icon:'☀️', label:'Học Sinh Chăm Chỉ',    description:'25 phiên hoàn thành trước 7:00 sáng',  dem:'earlyBirdCount', moc:25 },
  { id:'early_bird_50',  category:'timeofday', tier:'gold',     icon:'🌻', label:'Bình Minh Chiến Binh',  description:'50 phiên hoàn thành trước 7:00 sáng',  dem:'earlyBirdCount', moc:50 },
  { id:'early_bird_100', category:'timeofday', tier:'platinum', icon:'🦅', label:'Đại Bàng Bình Minh',    description:'100 phiên hoàn thành trước 7:00 sáng', dem:'earlyBirdCount', moc:100 },
  { id:'dawn_1',         category:'timeofday', tier:'bronze',   icon:'🌙', label:'Dậy Sớm',               description:'1 phiên hoàn thành trước 6:00 sáng',   dem:'dawnCount', moc:1 },
  { id:'dawn_10',        category:'timeofday', tier:'silver',   icon:'⭐', label:'Canh Tư Học Bài',       description:'10 phiên hoàn thành trước 6:00 sáng',  dem:'dawnCount', moc:10 },
  { id:'dawn_50',        category:'timeofday', tier:'gold',     icon:'🌟', label:'Bình Minh Bất Động',    description:'50 phiên hoàn thành trước 6:00 sáng',  dem:'dawnCount', moc:50 },
  { id:'five_am_1',      category:'timeofday', tier:'silver',   icon:'🌠', label:'Club 5 Giờ Sáng',       description:'1 phiên bắt đầu lúc 5:00–6:00 sáng',  dem:'fiveAmCount', moc:1 },
  { id:'five_am_20',     category:'timeofday', tier:'gold',     icon:'💫', label:'Người Của 5 Giờ Sáng',  description:'20 phiên bắt đầu lúc 5:00–6:00 sáng', dem:'fiveAmCount', moc:20 },
  { id:'night_owl_1',    category:'timeofday', tier:'bronze',   icon:'🦉', label:'Cú Đêm',                description:'1 phiên hoàn thành sau 23:00',          dem:'nightOwlCount', moc:1 },
  { id:'night_owl_5',    category:'timeofday', tier:'bronze',   icon:'🌙', label:'Thức Khuya Học Bài',    description:'5 phiên hoàn thành sau 23:00',          dem:'nightOwlCount', moc:5 },
  { id:'night_owl_10',   category:'timeofday', tier:'silver',   icon:'🔭', label:'Nhà Thiên Văn',         description:'10 phiên hoàn thành sau 23:00',         dem:'nightOwlCount', moc:10 },
  { id:'night_owl_25',   category:'timeofday', tier:'silver',   icon:'🌌', label:'Kẻ Yêu Bóng Tối',      description:'25 phiên hoàn thành sau 23:00',         dem:'nightOwlCount', moc:25 },
  { id:'night_owl_50',   category:'timeofday', tier:'gold',     icon:'🦇', label:'Ma Cà Rồng Học Thuật',  description:'50 phiên hoàn thành sau 23:00',         dem:'nightOwlCount', moc:50 },
  { id:'night_owl_100',  category:'timeofday', tier:'platinum', icon:'👁️', label:'Chúa Tể Bóng Đêm',    description:'100 phiên hoàn thành sau 23:00',        dem:'nightOwlCount', moc:100 },
  { id:'midnight_1',     category:'timeofday', tier:'silver',   icon:'🌃', label:'Nửa Đêm Thức Giấc',    description:'1 phiên hoàn thành sau 0:00 đêm',       dem:'midnightCount', moc:1 },
  { id:'midnight_5',     category:'timeofday', tier:'gold',     icon:'🌑', label:'Học Giả Nửa Đêm',      description:'5 phiên hoàn thành sau 0:00 đêm',       dem:'midnightCount', moc:5 },
  { id:'midnight_20',    category:'timeofday', tier:'platinum', icon:'🌙', label:'Huyền Thoại Nửa Đêm',  description:'20 phiên hoàn thành sau 0:00 đêm',      dem:'midnightCount', moc:20 },
  { id:'lunch_1',        category:'timeofday', tier:'bronze',   icon:'☕', label:'Giờ Ăn Trưa Tập Trung', description:'1 phiên lúc 12:00–13:00',              dem:'lunchCount', moc:1 },
  { id:'lunch_10',       category:'timeofday', tier:'silver',   icon:'🍱', label:'Chiến Binh Giờ Trưa',   description:'10 phiên lúc 12:00–13:00',             dem:'lunchCount', moc:10 },
  { id:'lunch_30',       category:'timeofday', tier:'gold',     icon:'🏆', label:'Vô Địch Giờ Trưa',      description:'30 phiên lúc 12:00–13:00',             dem:'lunchCount', moc:30 },
  { id:'teatime_5',      category:'timeofday', tier:'bronze',   icon:'🍵', label:'Giờ Trà Chiều',         description:'5 phiên lúc 15:00–16:00',              dem:'teatimeCount', moc:5 },
  { id:'teatime_25',     category:'timeofday', tier:'silver',   icon:'🫖', label:'Thói Quen Trà Chiều',   description:'25 phiên lúc 15:00–16:00',             dem:'teatimeCount', moc:25 },
  { id:'afternoon_20',   category:'timeofday', tier:'silver',   icon:'🌤️',label:'Chiều Tà Tập Trung',    description:'20 phiên lúc 14:00–17:00',             dem:'afternoonCount', moc:20 },
  { id:'afternoon_50',   category:'timeofday', tier:'gold',     icon:'🌅', label:'Buổi Chiều Vàng',       description:'50 phiên lúc 14:00–17:00',             dem:'afternoonCount', moc:50 },
  { id:'evening_20',     category:'timeofday', tier:'silver',   icon:'🌆', label:'Tối Về Học Bài',        description:'20 phiên lúc 18:00–22:00',             dem:'eveningCount', moc:20 },
  { id:'evening_50',     category:'timeofday', tier:'gold',     icon:'🌃', label:'Đêm Nhộn Nhịp',         description:'50 phiên lúc 18:00–22:00',             dem:'eveningCount', moc:50 },
  { id:'sunrise_10',     category:'timeofday', tier:'silver',   icon:'🌄', label:'Bình Minh Tri Thức',    description:'10 phiên lúc 6:00–7:00 sáng',         dem:'sunriseCount', moc:10 },
  { id:'full_day_1',     category:'timeofday', tier:'gold',     icon:'🌞', label:'Anh Hùng Cả Ngày',      description:'1 ngày có phiên cả sáng, chiều và tối', dem:'fullDayCount', moc:1 },
  { id:'full_day_5',     category:'timeofday', tier:'platinum', icon:'🌈', label:'Ngày Tràn Đầy Năng Lượng', description:'5 ngày có phiên cả sáng, chiều và tối', dem:'fullDayCount', moc:5 },

  // ══ THÀNH TÍCH NĂM (28) ══════════════════════════════════════════════════
  { id:'year_start',      category:'annual', tier:'bronze',   icon:'🗓️',label:'Chào Năm Mới',          description:'Phiên đầu tiên trong năm dương lịch',         dem:'sessionsThisYear', moc:1 },
  { id:'year_jan',        category:'annual', tier:'bronze',   icon:'❄️', label:'Tháng Giêng Bắt Đầu',  description:'Có phiên tập trung trong tháng 1',            dem:'janCount', moc:1 },
  { id:'year_feb',        category:'annual', tier:'bronze',   icon:'💝', label:'Tháng Hai Yêu Thương',  description:'Có phiên tập trung trong tháng 2',            dem:'febCount', moc:1 },
  { id:'year_mar',        category:'annual', tier:'bronze',   icon:'🌸', label:'Tháng Ba Nảy Mầm',      description:'Có phiên tập trung trong tháng 3',            dem:'marCount', moc:1 },
  { id:'year_apr',        category:'annual', tier:'bronze',   icon:'🌧️',label:'Tháng Tư Mưa Rào',      description:'Có phiên tập trung trong tháng 4',            dem:'aprCount', moc:1 },
  { id:'year_may',        category:'annual', tier:'bronze',   icon:'🌺', label:'Tháng Năm Rực Rỡ',      description:'Có phiên tập trung trong tháng 5',            dem:'mayCount', moc:1 },
  { id:'year_jun',        category:'annual', tier:'bronze',   icon:'☀️', label:'Tháng Sáu Mùa Hè',     description:'Có phiên tập trung trong tháng 6',            dem:'junCount', moc:1 },
  { id:'year_jul',        category:'annual', tier:'bronze',   icon:'🌊', label:'Tháng Bảy Biển Xanh',   description:'Có phiên tập trung trong tháng 7',            dem:'julCount', moc:1 },
  { id:'year_aug',        category:'annual', tier:'bronze',   icon:'🌻', label:'Tháng Tám Nắng Vàng',   description:'Có phiên tập trung trong tháng 8',            dem:'augCount', moc:1 },
  { id:'year_sep',        category:'annual', tier:'bronze',   icon:'🍂', label:'Tháng Chín Tựu Trường',  description:'Có phiên tập trung trong tháng 9',            dem:'sepCount', moc:1 },
  { id:'year_oct',        category:'annual', tier:'bronze',   icon:'🎃', label:'Tháng Mười Ma Quái',     description:'Có phiên tập trung trong tháng 10',           dem:'octCount', moc:1 },
  { id:'year_nov',        category:'annual', tier:'bronze',   icon:'🍁', label:'Tháng Mười Một Thu Về',  description:'Có phiên tập trung trong tháng 11',           dem:'novCount', moc:1 },
  { id:'year_dec',        category:'annual', tier:'bronze',   icon:'🎄', label:'Tháng Mười Hai Lễ Hội',  description:'Có phiên tập trung trong tháng 12',           dem:'decCount', moc:1 },
  { id:'year_all_months', category:'annual', tier:'gold',     icon:'📆', label:'Không Một Tháng Nghỉ',  description:'Có phiên trong đủ 12 tháng của năm nay',      dem:'monthsActiveThisYear', moc:12 },
  { id:'year_q1',         category:'annual', tier:'bronze',   icon:'🌱', label:'Quý 1 Bùng Cháy',       description:'≥10 phiên trong Quý 1 (tháng 1–3)',          dem:'q1Sessions', moc:10 },
  { id:'year_q2',         category:'annual', tier:'bronze',   icon:'🌿', label:'Quý 2 Phát Triển',       description:'≥10 phiên trong Quý 2 (tháng 4–6)',          dem:'q2Sessions', moc:10 },
  { id:'year_q3',         category:'annual', tier:'bronze',   icon:'🌳', label:'Quý 3 Sung Mãn',         description:'≥10 phiên trong Quý 3 (tháng 7–9)',          dem:'q3Sessions', moc:10 },
  { id:'year_q4',         category:'annual', tier:'bronze',   icon:'🎯', label:'Quý 4 Kết Tinh',         description:'≥10 phiên trong Quý 4 (tháng 10–12)',        dem:'q4Sessions', moc:10 },
  { id:'year_50h',        category:'annual', tier:'silver',   icon:'📅', label:'Nửa Trăm Giờ Năm Nay',  description:'50 giờ tập trung trong năm nay',              dem:'minutesThisYear', moc:3000 },
  { id:'year_100h',       category:'annual', tier:'gold',     icon:'🌟', label:'Trăm Giờ Vàng',          description:'100 giờ tập trung trong năm nay',             dem:'minutesThisYear', moc:6000 },
  { id:'year_200h',       category:'annual', tier:'platinum', icon:'💫', label:'Siêu Sao Năm Học',        description:'200 giờ tập trung trong năm nay',             dem:'minutesThisYear', moc:12000 },
  { id:'year_300h',       category:'annual', tier:'platinum', icon:'🏅', label:'Vô Địch Năm',             description:'300 giờ tập trung trong năm nay',             dem:'minutesThisYear', moc:18000 },
  { id:'year_500h',       category:'annual', tier:'diamond',  icon:'👑', label:'Năm Của Nhà Vô Địch',     description:'500 giờ tập trung trong năm nay',             dem:'minutesThisYear', moc:30000 },
  { id:'year_100s',       category:'annual', tier:'silver',   icon:'🎖️',label:'Trăm Phiên Năm Nay',     description:'100 phiên trong năm nay',                     dem:'sessionsThisYear', moc:100 },
  { id:'year_200s',       category:'annual', tier:'gold',     icon:'🏆', label:'Hai Trăm Phiên Năm Nay', description:'200 phiên trong năm nay',                     dem:'sessionsThisYear', moc:200 },
  { id:'year_365s',       category:'annual', tier:'diamond',  icon:'🌠', label:'Một Ngày Một Phiên',      description:'365 phiên trong năm — đỉnh cao ý chí',       dem:'sessionsThisYear', moc:365 },
  ...
  { id:'year_best_month', category:'annual', tier:'gold',     icon:'🥇', label:'Tháng Đỉnh Cao',          description:'Có tháng đạt ≥20 phiên trong năm nay',       dem:'bestMonthSessionsThisYear', moc:20 },
  ...
  { id:'first_blueprint', category:'collection', tier:'bronze',   icon:'📜', label:'Bản Vẽ Đầu Tiên',        description:'Thu được bản vẽ hiếm đầu tiên',         dem:'blueprintsCount', moc:1 },
  { id:'blueprints_5',    category:'collection', tier:'bronze',   icon:'📋', label:'Năm Bản Vẽ',              description:'Sưu tập 5 bản vẽ',                      dem:'blueprintsCount', moc:5 },
  { id:'blueprints_10',   category:'collection', tier:'silver',   icon:'🗺️', label:'Kiến Trúc Sư Tập Sự',    description:'Sưu tập 10 bản vẽ',                     dem:'blueprintsCount', moc:10 },
  { id:'blueprints_20',   category:'collection', tier:'silver',   icon:'🏗️', label:'Nhà Thiết Kế',            description:'Sưu tập 20 bản vẽ',                     dem:'blueprintsCount', moc:20 },
  { id:'blueprints_30',   category:'collection', tier:'gold',     icon:'📐', label:'Kiến Trúc Sư',             description:'Sưu tập 30 bản vẽ',                     dem:'blueprintsCount', moc:30 },
  { id:'blueprints_50',   category:'collection', tier:'gold',     icon:'🏛️', label:'Đại Kiến Trúc Sư',        description:'Sưu tập 50 bản vẽ',                     dem:'blueprintsCount', moc:50 },
  { id:'blueprints_75',   category:'collection', tier:'platinum', icon:'🌆', label:'Người Xây Thành Phố',     description:'Sưu tập 75 bản vẽ',                     dem:'blueprintsCount', moc:75 },
  { id:'blueprints_100',  category:'collection', tier:'diamond',  icon:'🏙️', label:'Kiến Trúc Sư Huyền Thoại', description:'Sưu tập 100 bản vẽ',                  dem:'blueprintsCount', moc:100 },
  { id:'first_relic',     category:'collection', tier:'bronze',   icon:'🌟', label:'Người Sưu Tập Huyền Thoại', description:'Chinh phục Era Crisis nhận Di Vật đầu tiên', dem:'relicsCount', moc:1 },
  { id:'two_relics',      category:'collection', tier:'silver',   icon:'💫', label:'Đôi Di Vật',              description:'Sưu tầm 2 Di Vật',                      dem:'relicsCount', moc:2 },
  { id:'all_relics',      category:'collection', tier:'gold',     icon:'🏛️', label:'Ghi Chép Toàn Lịch Sử',  description:'Sưu tầm đủ 3 Di Vật từ 3 Kỷ Nguyên',   dem:'relicsCount', moc:3 },
  { id:'jackpot_win',     category:'collection', tier:'silver',   icon:'🎰', label:'Con Cưng Của Vận May',    description:'Kích hoạt Đại Trúng Thưởng 1 lần',      dem:'totalJackpots', moc:1 },
  { id:'jackpot_3',       category:'collection', tier:'silver',   icon:'🍀', label:'Ba Lần Đại Vận',          description:'3 lần Đại Trúng Thưởng',                 dem:'totalJackpots', moc:3 },
  { id:'jackpot_10',      category:'collection', tier:'gold',     icon:'💰', label:'Số Đỏ Thường Xuyên',      description:'10 lần Đại Trúng Thưởng',                dem:'totalJackpots', moc:10 },
  { id:'jackpot_25',      category:'collection', tier:'gold',     icon:'🤑', label:'Chúa Vận May',             description:'25 lần Đại Trúng Thưởng',                dem:'totalJackpots', moc:25 },
  { id:'jackpot_50',      category:'collection', tier:'platinum', icon:'👑', label:'Thần Tài Chính Chủ',      description:'50 lần Đại Trúng Thưởng',                dem:'totalJackpots', moc:50 },
  { id:'jackpot_100',     category:'collection', tier:'diamond',  icon:'💸', label:'Vua Jackpot',              description:'100 lần Đại Trúng Thưởng',               dem:'totalJackpots', moc:100 },
  { id:'crafter_first',   category:'collection', tier:'bronze',   icon:'🔨', label:'Thợ Xây Đầu Tiên',        description:'Xây dựng công trình đầu tiên',           dem:'buildingsBuilt', moc:1 },
  { id:'crafter_3',       category:'collection', tier:'bronze',   icon:'🏠', label:'Khu Nhà Nhỏ',              description:'Xây dựng 3 công trình',                  dem:'buildingsBuilt', moc:3 },
  { id:'crafter_5',       category:'collection', tier:'silver',   icon:'🏰', label:'Kiến Trúc Sư Thực Thụ',   description:'Xây dựng 5 công trình',                  dem:'buildingsBuilt', moc:5 },
  { id:'crafter_10',      category:'collection', tier:'gold',     icon:'🌆', label:'Người Xây Thành Phố',      description:'Xây dựng 10 công trình',                 dem:'buildingsBuilt', moc:10 },
  { id:'prestige_first',  category:'collection', tier:'gold',     icon:'♾️', label:'Vòng Lặp Đầu Tiên',       description:'Hoàn thành Prestige lần đầu',            dem:'prestigeCount', moc:1 },
  { id:'prestige_3',      category:'collection', tier:'diamond',  icon:'🌀', label:'Ba Vòng Lặp',              description:'Hoàn thành Prestige 3 lần',              dem:'prestigeCount', moc:3 },

  // ══ PHIÊN ĐẶC BIỆT (22) ══════════════════════════════════════════════════
  { id:'marathon_session',   category:'session_type', tier:'silver',   icon:'🏃', label:'Marathon Tập Trung',    description:'1 phiên ≥90 phút',                      dem:'maxSessionMinutes', moc:90 },
  { id:'ultra_marathon',     category:'session_type', tier:'gold',     icon:'🚀', label:'Siêu Marathon',          description:'1 phiên ≥120 phút',                     dem:'maxSessionMinutes', moc:120 },
  { id:'titan_session',      category:'session_type', tier:'platinum', icon:'🏋️', label:'Titan Tập Trung',       description:'1 phiên ≥150 phút',                     dem:'maxSessionMinutes', moc:150 },
  { id:'godlike_session',    category:'session_type', tier:'diamond',  icon:'⚡', label:'Sức Mạnh Thần Thánh',   description:'1 phiên ≥180 phút',                     dem:'maxSessionMinutes', moc:180 },
  { id:'deep_focus_5',       category:'session_type', tier:'bronze',   icon:'🧘', label:'Tập Trung Sâu',          description:'5 phiên ≥60 phút',                      dem:'deepFocusCount', moc:5 },
  { id:'deep_focus_10',      category:'session_type', tier:'silver',   icon:'🌊', label:'Thiền Sâu',              description:'10 phiên ≥60 phút',                     dem:'deepFocusCount', moc:10 },
  { id:'deep_focus_25',      category:'session_type', tier:'silver',   icon:'🔮', label:'Trạng Thái Dòng Chảy',   description:'25 phiên ≥60 phút',                     dem:'deepFocusCount', moc:25 },
  { id:'deep_focus_50',      category:'session_type', tier:'gold',     icon:'💎', label:'Đại Dương Tĩnh Lặng',    description:'50 phiên ≥60 phút',                     dem:'deepFocusCount', moc:50 },
  { id:'deep_focus_100',     category:'session_type', tier:'platinum', icon:'🌌', label:'Bậc Thầy Tĩnh Tâm',     description:'100 phiên ≥60 phút',                    dem:'deepFocusCount', moc:100 },
  { id:'ultra_focus_10',     category:'session_type', tier:'gold',     icon:'🔥', label:'Lửa Marathon',           description:'10 phiên ≥90 phút',                     dem:'ultraFocusCount', moc:10 },
  { id:'ultra_focus_25',     category:'session_type', tier:'platinum', icon:'🌋', label:'Núi Lửa Ý Chí',          description:'25 phiên ≥90 phút',                     dem:'ultraFocusCount', moc:25 },
  { id:'power_day_4',        category:'session_type', tier:'silver',   icon:'💥', label:'Ngày Bùng Nổ',           description:'≥4 phiên trong 1 ngày',                 dem:'maxSessionsInDay', moc:4 },
  { id:'power_day_6',        category:'session_type', tier:'gold',     icon:'🌋', label:'Núi Lửa Tập Trung',      description:'≥6 phiên trong 1 ngày',                 dem:'maxSessionsInDay', moc:6 },
  { id:'power_day_8',        category:'session_type', tier:'platinum', icon:'⚡', label:'Sấm Sét Không Ngừng',    description:'≥8 phiên trong 1 ngày',                 dem:'maxSessionsInDay', moc:8 },
  { id:'power_day_10',       category:'session_type', tier:'diamond',  icon:'🌀', label:'Xoáy Tập Trung',         description:'≥10 phiên trong 1 ngày',                dem:'maxSessionsInDay', moc:10 },
  { id:'weekend_warrior_10', category:'session_type', tier:'bronze',   icon:'🎮', label:'Chiến Binh Cuối Tuần',   description:'10 phiên vào Thứ Bảy hoặc Chủ Nhật',   dem:'weekendCount', moc:10 },
  { id:'weekend_warrior_50', category:'session_type', tier:'silver',   icon:'🏆', label:'Vua Cuối Tuần',           description:'50 phiên vào Thứ Bảy hoặc Chủ Nhật',   dem:'weekendCount', moc:50 },
  { id:'legend_focus_5',     category:'session_type', tier:'diamond',  icon:'👑', label:'Huyền Thoại Tập Trung',  description:'5 phiên ≥180 phút',                     dem:'legendFocusCount', moc:5 },
  { id:'active_days_100',    category:'session_type', tier:'silver',   icon:'📅', label:'Trăm Ngày Hoạt Động',    description:'100 ngày khác nhau có ít nhất 1 phiên', dem:'totalActiveDays', moc:100 },
  { id:'active_days_365',    category:'session_type', tier:'gold',     icon:'🗓️', label:'365 Ngày Hoạt Động',    description:'365 ngày khác nhau có ít nhất 1 phiên', dem:'totalActiveDays', moc:365 },
  { id:'category_explorer',  category:'session_type', tier:'silver',   icon:'🗂️', label:'Khám Phá Đa Lĩnh Vực',  description:'Sử dụng ≥4 danh mục tập trung',         dem:'uniqueCategoriesUsed', moc:4 },
  { id:'category_master',    category:'session_type', tier:'gold',     icon:'🎓', label:'Bậc Thầy Đa Lĩnh Vực',  description:'Sử dụng ≥7 danh mục tập trung',         dem:'uniqueCategoriesUsed', moc:7 },

  // ══ GHI CHÚ (14) ══════════════════════════════════════════════════════════
  { id:'note_1',        category:'notes', tier:'bronze',   icon:'✏️', label:'Bút Đầu Tiên',         description:'Ghi chú trong 1 phiên',       dem:'totalNoteCount', moc:1 },
  { id:'note_5',        category:'notes', tier:'bronze',   icon:'📝', label:'Bắt Đầu Ghi Nhật Ký',  description:'Ghi chú trong 5 phiên',       dem:'totalNoteCount', moc:5 },
  { id:'note_10',       category:'notes', tier:'bronze',   icon:'📒', label:'Nhật Ký Tập Sự',        description:'Ghi chú trong 10 phiên',      dem:'totalNoteCount', moc:10 },
  { id:'note_25',       category:'notes', tier:'silver',   icon:'📓', label:'Nhà Ghi Chép',           description:'Ghi chú trong 25 phiên',      dem:'totalNoteCount', moc:25 },
  { id:'note_50',       category:'notes', tier:'silver',   icon:'✍️', label:'Học Giả Ghi Chép',      description:'Ghi chú trong 50 phiên',      dem:'totalNoteCount', moc:50 },
  { id:'note_100',      category:'notes', tier:'gold',     icon:'📔', label:'Biên Niên Sử Nhỏ',       description:'Ghi chú trong 100 phiên',     dem:'totalNoteCount', moc:100 },
  { id:'note_200',      category:'notes', tier:'gold',     icon:'📖', label:'Cuốn Sách Của Tôi',      description:'Ghi chú trong 200 phiên',     dem:'totalNoteCount', moc:200 },
  { id:'note_365',      category:'notes', tier:'platinum', icon:'🗒️', label:'Một Năm Ghi Chép',      description:'Ghi chú trong 365 phiên',     dem:'totalNoteCount', moc:365 },
  { id:'note_500',      category:'notes', tier:'platinum', icon:'📚', label:'Thư Viện Cá Nhân',       description:'Ghi chú trong 500 phiên',     dem:'totalNoteCount', moc:500 },
  { id:'note_1000',     category:'notes', tier:'diamond',  icon:'🏛️', label:'Biên Niên Sử Đại',      description:'Ghi chú trong 1000 phiên',    dem:'totalNoteCount', moc:1000 },
  { id:'note_long_1',   category:'notes', tier:'silver',   icon:'📜', label:'Ghi Chú Sâu Sắc',        description:'1 ghi chú ≥150 ký tự',        dem:'longNoteCount', moc:1 },
  { id:'note_long_10',  category:'notes', tier:'gold',     icon:'📕', label:'Nhà Tư Tưởng',            description:'10 ghi chú ≥150 ký tự',       dem:'longNoteCount', moc:10 },
  { id:'note_long_50',  category:'notes', tier:'platinum', icon:'📗', label:'Triết Gia',               description:'50 ghi chú ≥150 ký tự',       dem:'longNoteCount', moc:50 },
  { id:'note_long_100', category:'notes', tier:'diamond',  icon:'🎭', label:'Nhà Hiền Triết',          description:'100 ghi chú ≥150 ký tự',      dem:'longNoteCount', moc:100 },

  // ══ KỶ NGUYÊN & BẬC (17) ══════════════════════════════════════════════════
  { id:'era_2',      category:'era_rank', tier:'bronze',   icon:'🌍', label:'Kỷ Nguyên Mới',           description:'Bước vào Quyển 2',                  dem:'activeBook', moc:2 },
  { id:'era_3',      category:'era_rank', tier:'bronze',   icon:'🌎', label:'Thế Giới Thứ Ba',          description:'Bước vào Quyển 3',                  dem:'activeBook', moc:3 },
  { id:'era_4',      category:'era_rank', tier:'silver',   icon:'🌏', label:'Bốn Phương Đất Trời',      description:'Bước vào Quyển 4',                  dem:'activeBook', moc:4 },
  { id:'era_5',      category:'era_rank', tier:'silver',   icon:'🌌', label:'Giữa Ngân Hà',             description:'Bước vào Quyển 5',                  dem:'activeBook', moc:5 },
  { id:'era_6',      category:'era_rank', tier:'gold',     icon:'🚀', label:'Người Thám Hiểm Vũ Trụ',  description:'Bước vào Quyển 6',                  dem:'activeBook', moc:6 },
  { id:'era_7',      category:'era_rank', tier:'gold',     icon:'⭐', label:'Ánh Sao Thứ Bảy',          description:'Bước vào Quyển 7',                  dem:'activeBook', moc:7 },
  { id:'era_8',      category:'era_rank', tier:'platinum', icon:'🌠', label:'Ranh Giới Vũ Trụ',         description:'Bước vào Quyển 8',                  dem:'activeBook', moc:8 },
  { id:'era_9',      category:'era_rank', tier:'platinum', icon:'💫', label:'Gần Đến Đỉnh',             description:'Bước vào Quyển 9',                  dem:'activeBook', moc:9 },
  { id:'era_10',     category:'era_rank', tier:'diamond',  icon:'👑', label:'Phi Hành Gia Lịch Sử',    description:'Bước vào Quyển 10',                 dem:'activeBook', moc:10 },
  { id:'rank_2',     category:'era_rank', tier:'bronze',   icon:'🥈', label:'Bước Lên Bậc Hai',         description:'Đạt rank 2 trong bất kỳ Kỷ Nguyên', dem:'maxRankAchieved', moc:2 },
  { id:'rank_4',     category:'era_rank', tier:'silver',   icon:'🏅', label:'Danh Dự',                  description:'Đạt rank 4',                         dem:'maxRankAchieved', moc:4 },
  { id:'rank_5',     category:'era_rank', tier:'gold',     icon:'🥇', label:'Tinh Hoa',                 description:'Đạt rank 5',                         dem:'maxRankAchieved', moc:5 },
  { id:'rank_6',     category:'era_rank', tier:'platinum', icon:'💎', label:'Bậc Thầy Kỷ Nguyên',      description:'Đạt rank 6',                         dem:'maxRankAchieved', moc:6 },
  { id:'max_rank',   category:'era_rank', tier:'platinum', icon:'👑', label:'Đỉnh Phong Danh Vọng',     description:'Đạt rank 7 — bậc danh xưng tối cao', dem:'maxRankAchieved', moc:7 },
  { id:'prestige_1', category:'era_rank', tier:'gold',     icon:'♾️', label:'Vòng Lặp Mới',             description:'Hoàn thành Prestige lần đầu',        dem:'prestigeCount', moc:1 },
  { id:'prestige_5', category:'era_rank', tier:'platinum', icon:'🌀', label:'Năm Vòng Lặp',             description:'Hoàn thành Prestige 5 lần',           dem:'prestigeCount', moc:5 },
  { id:'prestige_10',category:'era_rank', tier:'diamond',  icon:'∞',  label:'Vô Tận',                   description:'Hoàn thành Prestige 10 lần',          dem:'prestigeCount', moc:10 },

  // ══ NGÀY TRONG TUẦN (28) ══════════════════════════════════════════════════
  { id:'mon_10', category:'day_of_week', tier:'bronze', icon:'📅', label:'Thứ Hai Năng Động',   description:'10 phiên vào Thứ Hai',   dem:'monCount', moc:10 },
  { id:'tue_10', category:'day_of_week', tier:'bronze', icon:'📅', label:'Thứ Ba Bật Máy',      description:'10 phiên vào Thứ Ba',    dem:'tueCount', moc:10 },
  { id:'wed_10', category:'day_of_week', tier:'bronze', icon:'📅', label:'Thứ Tư Giữa Tuần',    description:'10 phiên vào Thứ Tư',    dem:'wedCount', moc:10 },
  { id:'thu_10', category:'day_of_week', tier:'bronze', icon:'📅', label:'Thứ Năm Bứt Phá',     description:'10 phiên vào Thứ Năm',   dem:'thuCount', moc:10 },
  { id:'fri_10', category:'day_of_week', tier:'bronze', icon:'📅', label:'Thứ Sáu Kết Tuần',    description:'10 phiên vào Thứ Sáu',   dem:'friCount', moc:10 },
  { id:'sat_10', category:'day_of_week', tier:'bronze', icon:'📅', label:'Thứ Bảy Học Vui',     description:'10 phiên vào Thứ Bảy',   dem:'satCount', moc:10 },
  { id:'sun_10', category:'day_of_week', tier:'bronze', icon:'📅', label:'Chủ Nhật Tri Thức',   description:'10 phiên vào Chủ Nhật',  dem:'sunCount', moc:10 },
  { id:'mon_50', category:'day_of_week', tier:'silver', icon:'💪', label:'Chuyên Gia Thứ Hai',  description:'50 phiên vào Thứ Hai',   dem:'monCount', moc:50 },
  { id:'tue_50', category:'day_of_week', tier:'silver', icon:'💪', label:'Chuyên Gia Thứ Ba',   description:'50 phiên vào Thứ Ba',    dem:'tueCount', moc:50 },
  { id:'wed_50', category:'day_of_week', tier:'silver', icon:'💪', label:'Chuyên Gia Thứ Tư',   description:'50 phiên vào Thứ Tư',    dem:'wedCount', moc:50 },
  { id:'thu_50', category:'day_of_week', tier:'silver', icon:'💪', label:'Chuyên Gia Thứ Năm',  description:'50 phiên vào Thứ Năm',   dem:'thuCount', moc:50 },
  { id:'fri_50', category:'day_of_week', tier:'silver', icon:'💪', label:'Chuyên Gia Thứ Sáu',  description:'50 phiên vào Thứ Sáu',   dem:'friCount', moc:50 },
  { id:'sat_50', category:'day_of_week', tier:'silver', icon:'🎮', label:'Chuyên Gia Thứ Bảy',  description:'50 phiên vào Thứ Bảy',   dem:'satCount', moc:50 },
  { id:'sun_50', category:'day_of_week', tier:'silver', icon:'🌟', label:'Chuyên Gia Chủ Nhật', description:'50 phiên vào Chủ Nhật',  dem:'sunCount', moc:50 },
  { id:'mon_100',category:'day_of_week', tier:'gold',   icon:'🔱', label:'Thứ Hai Huyền Thoại', description:'100 phiên vào Thứ Hai',  dem:'monCount', moc:100 },
  { id:'tue_100',category:'day_of_week', tier:'gold',   icon:'🔱', label:'Thứ Ba Huyền Thoại',  description:'100 phiên vào Thứ Ba',   dem:'tueCount', moc:100 },
  { id:'wed_100',category:'day_of_week', tier:'gold',   icon:'🔱', label:'Thứ Tư Huyền Thoại',  description:'100 phiên vào Thứ Tư',   dem:'wedCount', moc:100 },
  { id:'thu_100',category:'day_of_week', tier:'gold',   icon:'🔱', label:'Thứ Năm Huyền Thoại', description:'100 phiên vào Thứ Năm',  dem:'thuCount', moc:100 },
  { id:'fri_100',category:'day_of_week', tier:'gold',   icon:'🔱', label:'Thứ Sáu Huyền Thoại', description:'100 phiên vào Thứ Sáu',  dem:'friCount', moc:100 },
  { id:'sat_100',category:'day_of_week', tier:'gold',   icon:'🏆', label:'Thứ Bảy Huyền Thoại', description:'100 phiên vào Thứ Bảy',  dem:'satCount', moc:100 },
  { id:'sun_100',category:'day_of_week', tier:'gold',   icon:'👑', label:'Chủ Nhật Huyền Thoại',description:'100 phiên vào Chủ Nhật', dem:'sunCount', moc:100 },
  { id:'weekday_100',  category:'day_of_week', tier:'silver',   icon:'🏢', label:'Nhân Viên Cần Mẫn',    description:'100 phiên vào ngày thường (T2–T6)', dem:'weekdayCount', moc:100 },
  { id:'weekday_300',  category:'day_of_week', tier:'gold',     icon:'💼', label:'Siêu Nhân Văn Phòng',  description:'300 phiên vào ngày thường (T2–T6)', dem:'weekdayCount', moc:300 },
  { id:'weekend_50',   category:'day_of_week', tier:'silver',   icon:'🎯', label:'Cuối Tuần Chiến Binh', description:'50 phiên vào cuối tuần',            dem:'weekendCount', moc:50 },
  { id:'weekend_150',  category:'day_of_week', tier:'gold',     icon:'🏆', label:'Vua Cuối Tuần',         description:'150 phiên vào cuối tuần',           dem:'weekendCount', moc:150 },
  { id:'weekend_300',  category:'day_of_week', tier:'platinum', icon:'👑', label:'Chúa Tể Cuối Tuần',    description:'300 phiên vào cuối tuần',           dem:'weekendCount', moc:300 },
  ...
  // ══ HÀNG THÁNG (26) ═══════════════════════════════════════════════════════
  { id:'month_10',   category:'monthly', tier:'bronze',  icon:'📊', label:'Tháng 10 Phiên',        description:'Có tháng đạt ≥10 phiên',      dem:'bestMonthSessions', moc:10 },
  { id:'month_20',   category:'monthly', tier:'silver',  icon:'📈', label:'Tháng 20 Phiên',        description:'Có tháng đạt ≥20 phiên',      dem:'bestMonthSessions', moc:20 },
  { id:'month_30',   category:'monthly', tier:'silver',  icon:'🔥', label:'Tháng Sung Mãn',         description:'Có tháng đạt ≥30 phiên',      dem:'bestMonthSessions', moc:30 },
  { id:'month_50',   category:'monthly', tier:'gold',    icon:'⚡', label:'Tháng Bùng Nổ',          description:'Có tháng đạt ≥50 phiên',      dem:'bestMonthSessions', moc:50 },
  { id:'month_100',  category:'monthly', tier:'diamond', icon:'🌌', label:'Tháng Huyền Thoại',      description:'Có tháng đạt ≥100 phiên',     dem:'bestMonthSessions', moc:100 },
  { id:'month_5h',   category:'monthly', tier:'bronze',  icon:'⏰', label:'5 Giờ Tháng Này',        description:'Có tháng đạt ≥5 giờ',         dem:'bestMonthMinutes', moc:300 },
  { id:'month_10h',  category:'monthly', tier:'silver',  icon:'📚', label:'10 Giờ Một Tháng',       description:'Có tháng đạt ≥10 giờ',        dem:'bestMonthMinutes', moc:600 },
  { id:'month_20h',  category:'monthly', tier:'silver',  icon:'🕰️', label:'20 Giờ Vàng',           description:'Có tháng đạt ≥20 giờ',        dem:'bestMonthMinutes', moc:1200 },
  { id:'month_30h',  category:'monthly', tier:'gold',    icon:'🔮', label:'Ba Mươi Giờ',            description:'Có tháng đạt ≥30 giờ',        dem:'bestMonthMinutes', moc:1800 },
  { id:'month_50h',  category:'monthly', tier:'platinum',icon:'💎', label:'Tháng Kim Cương',         description:'Có tháng đạt ≥50 giờ',        dem:'bestMonthMinutes', moc:3000 },
  { id:'jan_20',     category:'monthly', tier:'silver',  icon:'❄️', label:'Tháng Giêng Tập Trung',  description:'≥20 phiên vào tháng 1',       dem:'janCount', moc:20 },
  { id:'feb_20',     category:'monthly', tier:'silver',  icon:'💝', label:'Tháng Hai Tập Trung',    description:'≥20 phiên vào tháng 2',       dem:'febCount', moc:20 },
  { id:'mar_20',     category:'monthly', tier:'silver',  icon:'🌸', label:'Tháng Ba Tập Trung',     description:'≥20 phiên vào tháng 3',       dem:'marCount', moc:20 },
  { id:'apr_20',     category:'monthly', tier:'silver',  icon:'🌧️',label:'Tháng Tư Tập Trung',     description:'≥20 phiên vào tháng 4',       dem:'aprCount', moc:20 },
  { id:'may_20',     category:'monthly', tier:'silver',  icon:'🌺', label:'Tháng Năm Tập Trung',    description:'≥20 phiên vào tháng 5',       dem:'mayCount', moc:20 },
  { id:'jun_20',     category:'monthly', tier:'silver',  icon:'☀️', label:'Tháng Sáu Tập Trung',   description:'≥20 phiên vào tháng 6',       dem:'junCount', moc:20 },
  { id:'jul_20',     category:'monthly', tier:'silver',  icon:'🌊', label:'Tháng Bảy Tập Trung',    description:'≥20 phiên vào tháng 7',       dem:'julCount', moc:20 },
  { id:'aug_20',     category:'monthly', tier:'silver',  icon:'🌻', label:'Tháng Tám Tập Trung',    description:'≥20 phiên vào tháng 8',       dem:'augCount', moc:20 },
  { id:'sep_20',     category:'monthly', tier:'silver',  icon:'🍂', label:'Tháng Chín Tập Trung',   description:'≥20 phiên vào tháng 9',       dem:'sepCount', moc:20 },
  { id:'oct_20',     category:'monthly', tier:'silver',  icon:'🎃', label:'Tháng Mười Tập Trung',   description:'≥20 phiên vào tháng 10',      dem:'octCount', moc:20 },
  { id:'nov_20',     category:'monthly', tier:'silver',  icon:'🍁', label:'Tháng 11 Tập Trung',     description:'≥20 phiên vào tháng 11',      dem:'novCount', moc:20 },
  { id:'dec_20',     category:'monthly', tier:'silver',  icon:'🎄', label:'Tháng 12 Tập Trung',     description:'≥20 phiên vào tháng 12',      dem:'decCount', moc:20 },
  { id:'q1_champion',category:'monthly', tier:'gold',    icon:'🌱', label:'Quán Quân Quý 1',         description:'≥30 phiên trong Quý 1',       dem:'q1Sessions', moc:30 },
  { id:'q2_champion',category:'monthly', tier:'gold',    icon:'🌿', label:'Quán Quân Quý 2',         description:'≥30 phiên trong Quý 2',       dem:'q2Sessions', moc:30 },
  { id:'q3_champion',category:'monthly', tier:'gold',    icon:'🌳', label:'Quán Quân Quý 3',         description:'≥30 phiên trong Quý 3',       dem:'q3Sessions', moc:30 },
  { id:'q4_champion',category:'monthly', tier:'gold',    icon:'🎯', label:'Quán Quân Quý 4',         description:'≥30 phiên trong Quý 4',       dem:'q4Sessions', moc:30 },

  // ══ XP & CẤP ĐỘ (20) ════════════════════════════════════════════════════
  { id:'xp_1000',    category:'xp_level', tier:'bronze',   icon:'⭐', label:'1 Nghìn XP',            description:'Tích lũy 1,000 XP',     dem:'totalXP', moc:1000 },
  { id:'xp_5000',    category:'xp_level', tier:'bronze',   icon:'🌟', label:'5 Nghìn XP',            description:'Tích lũy 5,000 XP',     dem:'totalXP', moc:5000 },
  { id:'xp_10000',   category:'xp_level', tier:'silver',   icon:'💫', label:'10 Nghìn XP',           description:'Tích lũy 10,000 XP',    dem:'totalXP', moc:10000 },
  { id:'xp_25000',   category:'xp_level', tier:'silver',   icon:'✨', label:'25 Nghìn XP',           description:'Tích lũy 25,000 XP',    dem:'totalXP', moc:25000 },
  { id:'xp_50000',   category:'xp_level', tier:'gold',     icon:'🔥', label:'50 Nghìn XP',           description:'Tích lũy 50,000 XP',    dem:'totalXP', moc:50000 },
  { id:'xp_100000',  category:'xp_level', tier:'gold',     icon:'💎', label:'100 Nghìn XP',          description:'Tích lũy 100,000 XP',   dem:'totalXP', moc:100000 },
  { id:'xp_250000',  category:'xp_level', tier:'platinum', icon:'👑', label:'250 Nghìn XP',          description:'Tích lũy 250,000 XP',   dem:'totalXP', moc:250000 },
  { id:'xp_500000',  category:'xp_level', tier:'platinum', icon:'🌌', label:'Nửa Triệu XP',          description:'Tích lũy 500,000 XP',   dem:'totalXP', moc:500000 },
  { id:'xp_1000000', category:'xp_level', tier:'diamond',  icon:'∞',  label:'Triệu XP Huyền Thoại', description:'Tích lũy 1,000,000 XP', dem:'totalXP', moc:1000000 },
  { id:'level_5',    category:'xp_level', tier:'bronze',   icon:'🌱', label:'Cấp 5',                 description:'Đạt cấp độ 5',          dem:'playerLevel', moc:5 },
  { id:'level_10',   category:'xp_level', tier:'silver',   icon:'🌿', label:'Cấp 10',                description:'Đạt cấp độ 10',         dem:'playerLevel', moc:10 },
  { id:'level_20',   category:'xp_level', tier:'silver',   icon:'🌳', label:'Cấp 20',                description:'Đạt cấp độ 20',         dem:'playerLevel', moc:20 },
  { id:'level_30',   category:'xp_level', tier:'gold',     icon:'🔥', label:'Cấp 30',                description:'Đạt cấp độ 30',         dem:'playerLevel', moc:30 },
  { id:'level_50',   category:'xp_level', tier:'gold',     icon:'⚡', label:'Cấp 50',                description:'Đạt cấp độ 50',         dem:'playerLevel', moc:50 },
  { id:'level_75',   category:'xp_level', tier:'platinum', icon:'💎', label:'Cấp 75',                description:'Đạt cấp độ 75',         dem:'playerLevel', moc:75 },
  { id:'level_100',  category:'xp_level', tier:'diamond',  icon:'👑', label:'Cấp 100',               description:'Đạt cấp độ 100',        dem:'playerLevel', moc:100 },
  { id:'days_30',    category:'xp_level', tier:'bronze',   icon:'📅', label:'30 Ngày Cùng DC Pomodoro',description:'30 ngày kể từ phiên đầu', dem:'daysSinceFirst', moc:30 },
  { id:'days_100',   category:'xp_level', tier:'silver',   icon:'🗓️', label:'100 Ngày',               description:'100 ngày kể từ phiên đầu', dem:'daysSinceFirst', moc:100 },
  { id:'days_365',   category:'xp_level', tier:'gold',     icon:'🌟', label:'Một Năm Cùng DC Pomodoro',description:'365 ngày kể từ phiên đầu', dem:'daysSinceFirst', moc:365 },
  { id:'days_730',   category:'xp_level', tier:'diamond',  icon:'∞',  label:'Hai Năm Cùng DC Pomodoro',description:'730 ngày kể từ phiên đầu', dem:'daysSinceFirst', moc:730 },
  ...
  { id:'triple_seven',   category:'special', tier:'diamond',  icon:'🍀', label:'777 — Số Huyền Thoại', description:'Đạt đúng 777 phiên tập trung',                        dem:'sessionsCompleted', moc:777 },
  { id:'lucky_7_day',    category:'special', tier:'gold',     icon:'7️⃣',label:'Ngày Thất Tốt Lành',   description:'Đúng 7 phiên trong 1 ngày',                           dem:'maxSessionsInDay', moc:7 },
  { id:'fibonacci_144',  category:'special', tier:'gold',     icon:'🌀', label:'Fibonacci 144',         description:'144 phiên — số Fibonacci huyền diệu',               dem:'sessionsCompleted', moc:144 },
  ...
  { id:'veteran_365',    category:'special', tier:'gold',     icon:'🦅', label:'Chiến Binh 365 Ngày',  description:'365 ngày kể từ lần đầu tập trung',                   dem:'daysSinceFirst', moc:365 },
  { id:'all_categories', category:'special', tier:'platinum', icon:'🎨', label:'Người Đa Tài',          description:'Sử dụng ≥6 danh mục khác nhau',                      dem:'uniqueCategoriesUsed', moc:6 },
  ...
  { id:'time_wizard',    category:'special', tier:'diamond',  icon:'🧙', label:'Phù Thủy Thời Gian',   description:'≥1000 giờ tập trung tổng cộng',                      dem:'totalFocusMinutes', moc:60000 },
  ...
  // ══ BỔ SUNG ═══════════════════════════════════════════════════════════════
  // Sessions thêm
  { id:'sessions_400',   category:'sessions',  tier:'platinum', icon:'⚡', label:'Bốn Trăm Phiên',          description:'400 phiên tập trung',                     dem:'sessionsCompleted', moc:400 },
  { id:'sessions_800',   category:'sessions',  tier:'platinum', icon:'🔮', label:'Tám Trăm Phiên',          description:'800 phiên tập trung',                     dem:'sessionsCompleted', moc:800 },
  { id:'sessions_1111',  category:'sessions',  tier:'diamond',  icon:'🎯', label:'Một Một Một Một',          description:'1111 phiên — bộ số thú vị',              dem:'sessionsCompleted', moc:1111 },
  // Time thêm
  { id:'hours_30',       category:'time',      tier:'silver',   icon:'🌙', label:'Ba Mươi Giờ',              description:'30 giờ tập trung tích lũy',              dem:'totalFocusMinutes', moc:1800 },
  { id:'hours_450',      category:'time',      tier:'platinum', icon:'🌊', label:'Bốn Trăm Rưỡi Giờ',        description:'450 giờ tập trung tích lũy',             dem:'totalFocusMinutes', moc:27000 },
  // Streak thêm
  { id:'streak_15',      category:'streak',    tier:'silver',   icon:'🔗', label:'Mười Lăm Ngày',            description:'Streak 15 ngày liên tiếp',               dem:'longestStreak', moc:15 },
  { id:'streak_45',      category:'streak',    tier:'gold',     icon:'🌟', label:'Bốn Mươi Lăm Ngày',        description:'Streak 45 ngày liên tiếp',               dem:'longestStreak', moc:45 },
  // Time of day thêm
  { id:'early_bird_200', category:'timeofday', tier:'diamond',  icon:'🌠', label:'Huyền Thoại Bình Minh',    description:'200 phiên trước 7:00 sáng',              dem:'earlyBirdCount', moc:200 },
  { id:'night_owl_200',  category:'timeofday', tier:'diamond',  icon:'🌌', label:'Huyền Thoại Đêm Khuya',   description:'200 phiên sau 23:00',                    dem:'nightOwlCount', moc:200 },
  // Annual thêm
  ...
  // Collection thêm
  { id:'blueprints_40',  category:'collection',tier:'gold',     icon:'📑', label:'Bốn Mươi Bản Vẽ',         description:'Sưu tập 40 bản vẽ',                     dem:'blueprintsCount', moc:40 },
  { id:'jackpot_5',      category:'collection',tier:'silver',   icon:'🎲', label:'Năm Lần Đại Vận',          description:'5 lần Đại Trúng Thưởng',                dem:'totalJackpots', moc:5 },
  // Session type thêm
  { id:'deep_focus_200', category:'session_type',tier:'diamond',icon:'🌊', label:'Đại Dương Vô Tận',         description:'200 phiên ≥60 phút',                    dem:'deepFocusCount', moc:200 },
  { id:'active_days_200',category:'session_type',tier:'platinum',icon:'📆',label:'200 Ngày Hoạt Động',       description:'200 ngày khác nhau có ít nhất 1 phiên', dem:'totalActiveDays', moc:200 },
  // Notes thêm
  { id:'note_700',       category:'notes',     tier:'diamond',  icon:'📗', label:'Bảy Trăm Ghi Chú',        description:'Ghi chú trong 700 phiên',               dem:'totalNoteCount', moc:700 },
  // Era rank thêm
  { id:'rank_3',         category:'era_rank',  tier:'silver',   icon:'🏅', label:'Bậc Ba',                  description:'Đạt rank 3 trong bất kỳ Kỷ Nguyên',    dem:'maxRankAchieved', moc:3 },
  // Monthly thêm
  { id:'month_75',       category:'monthly',   tier:'platinum', icon:'🌟', label:'Bảy Mươi Lăm Phiên',      description:'Có tháng đạt ≥75 phiên',               dem:'bestMonthSessions', moc:75 },
  // XP level thêm
  { id:'xp_500',         category:'xp_level',  tier:'bronze',   icon:'✨', label:'500 XP',                  description:'Tích lũy 500 XP',                       dem:'totalXP', moc:500 },
  { id:'level_15',       category:'xp_level',  tier:'silver',   icon:'🌿', label:'Cấp 15',                  description:'Đạt cấp độ 15',                         dem:'playerLevel', moc:15 },
  // Special thêm
  { id:'full_day_10',    category:'special',   tier:'diamond',  icon:'🌞', label:'Mười Ngày Tràn Đầy',       description:'10 ngày có phiên cả sáng, chiều và tối', dem:'fullDayCount', moc:10 },
...
// 310/360 mục ở trên chỉ là một phép so ngưỡng đơn, nên chúng khai `dem` (đếm trường nào) + `moc`
// (bao nhiêu thì đạt) thay vì tự viết `check`. Nhờ vậy con số ngưỡng tồn tại ĐÚNG MỘT CHỖ và màn
// Thành tích đọc được nó để hiện "còn 3 phiên nữa" — trước đây 360/360 mục chỉ có đạt/chưa đạt.
//
// ⚠️ ĐỪNG chép ngưỡng ra một bảng thứ hai đứng cạnh `check`: hai bản sẽ trôi khỏi nhau và không có
// gì đỏ lên. Và ĐỪNG đọc ngưỡng bằng cách phân tích mã nguồn của `check` — cách ấy chạy đúng dưới
// `node` rồi hỏng CÂM trên bản thật, vì Vite rút gọn `s.sessionsCompleted` thành `s.a`.
//
// 50 mục còn lại (điều kiện ghép, cờ ngày lễ, `Math.min` nhiều trường…) vẫn tự viết `check` và
// KHÔNG có tiến độ — `tienDoThanhTich` trả `null` cho chúng, đó là câu trả lời thật.
for (const _a of ACHIEVEMENTS) {
  if (typeof _a.check !== 'function') _a.check = checkTuNguong(_a.dem, _a.moc);
}
